        ...
        <section className="relative overflow-hidden py-16 sm:py-20 lg:py-32">
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 sm:mt-6 text-base sm:text-lg text-muted-foreground sm:text-xl max-w-2xl mx-auto">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                <Button size="lg" asChild data-testid="button-get-started" className="w-full sm:w-auto">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-center gap-x-4 sm:gap-x-6 gap-y-2 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="mt-10 sm:mt-16 grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="hover-elevate">
                <CardContent className="p-5 sm:pt-6">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-chart-1/10">
                    <PieChart className="h-5 w-5 sm:h-6 sm:w-6 text-chart-1" />
                  </div>
                  <h3 className="mt-3 sm:mt-4 font-semibold">Spending Overview</h3>
              ...
              <Card className="hover-elevate">
                <CardContent className="p-5 sm:pt-6">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-chart-2/10">
                    <Bell className="h-5 w-5 sm:h-6 sm:w-6 text-chart-2" />
                  </div>
                  <h3 className="mt-3 sm:mt-4 font-semibold">Renewal Reminders</h3>
                  <p className="mt-1.5 sm:mt-2 text-sm text-muted-foreground">
              ...
              <Card className="hover-elevate">
                <CardContent className="p-5 sm:pt-6">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-chart-3/10">
                    <CreditCard className="h-5 w-5 sm:h-6 sm:w-6 text-chart-3" />
                  </div>
                  <h3 className="mt-3 sm:mt-4 font-semibold">Track Trials</h3>
                  <p className="mt-1.5 sm:mt-2 text-sm text-muted-foreground">
              ...
              <Card className="hover-elevate">
                <CardContent className="p-5 sm:pt-6">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-chart-4/10">
                    <Shield className="h-5 w-5 sm:h-6 sm:w-6 text-chart-4" />
                  </div>
                  <h3 className="mt-3 sm:mt-4 font-semibold">Secure & Private</h3>
                  <p className="mt-1.5 sm:mt-2 text-sm text-muted-foreground">
        ...
        <section className="py-16 sm:py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-xl text-center">
              ...
              <Button size="lg" className="mt-6 sm:mt-8 w-full sm:w-auto" asChild data-testid="button-cta-bottom">
                <a href="/signup" className="gap-2">
                  Start Tracking Now
                  <ArrowRight className="h-4 w-4" />
                </a>
