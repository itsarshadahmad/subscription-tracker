...
import { Plus, Search, DollarSign, Calendar, CreditCard, AlertTriangle, Pencil, Trash2, ArrowUpDown, Download } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            {subsLoading ? (
              ...
              <div className="text-2xl font-bold" data-testid="text-yearly-cost">
        ...
        <Card>
          ...
          <CardContent>
            {subsLoading ? (
              ...
              <div className="text-2xl font-bold" data-testid="text-upcoming-renewals">
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button onClick={() => exportMutation.mutate()} variant="outline" size="sm" disabled={exportMutation.isPending} data-testid="button-export">
        ...
        <CardContent>
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
            ...
            <Select value={cycleFilter} onValueChange={setCycleFilter}>
              <SelectTrigger className="w-[140px]" data-testid="select-cycle-filter">
